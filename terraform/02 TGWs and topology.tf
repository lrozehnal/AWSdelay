...
## CREATE 4 route-tables for each TGW one
resource "aws_ec2_transit_gateway_route_table" "us-east-1-TGW-RT" {
  provider           = aws.us-east-1
  transit_gateway_id = aws_ec2_transit_gateway.us-east-1-TGW.id
  tags = merge(local.tags, {
    Name = "default route table for us-east-1 TGW"
  })
}

resource "aws_ec2_transit_gateway_route_table" "us-west-1-TGW-RT" {
  provider           = aws.us-west-1
  transit_gateway_id = aws_ec2_transit_gateway.us-west-1-TGW.id
  tags = merge(local.tags, {
    Name = "default route table for us-west-1 TGW"
  })
}

resource "aws_ec2_transit_gateway_route_table" "ap-southeast-1-TGW-RT" {
  provider           = aws.ap-southeast-1
  transit_gateway_id = aws_ec2_transit_gateway.ap-southeast-1-TGW.id
  tags = merge(local.tags, {
    Name = "default route table for ap-southeast-1 TGW"
  })
}

resource "aws_ec2_transit_gateway_route_table" "ap-southeast-2-TGW-RT" {
  provider           = aws.ap-southeast-2
  transit_gateway_id = aws_ec2_transit_gateway.ap-southeast-2-TGW.id
  tags = merge(local.tags, {
    Name = "default route table for ap-southeast-2 TGW"
  })
}
...
resource "aws_ec2_transit_gateway_route" "us-east-1-TGW-routes-for-peering-with-us-west-1" {
  ...
  transit_gateway_attachment_id  = aws_ec2_transit_gateway_peering_attachment.us-west-1-to-us-east-1.id
  transit_gateway_route_table_id = aws_ec2_transit_gateway_route_table.us-east-1-TGW-RT.id
}
resource "aws_ec2_transit_gateway_route" "us-west-1-TGW-routes-for-peering-with-us-east-1" {
  ...
  transit_gateway_attachment_id  = aws_ec2_transit_gateway_peering_attachment.us-west-1-to-us-east-1.id
  transit_gateway_route_table_id = aws_ec2_transit_gateway_route_table.us-west-1-TGW-RT.id
}
...
resource "aws_ec2_transit_gateway_route" "ap-southeast-1-TGW-routes-for-peering-with-us-east-1" {
  ...
  destination_cidr_block         = local.aws_config_env.vpc.server.cidr
  transit_gateway_attachment_id  = aws_ec2_transit_gateway_peering_attachment.ap-southeast-1-to-us-east-1.id
  transit_gateway_route_table_id = aws_ec2_transit_gateway_route_table.ap-southeast-1-TGW-RT.id
}
...
resource "aws_ec2_transit_gateway_route" "ap-southeast-2-TGW-routes-for-peering-with-us-east-1" {
  ...
  destination_cidr_block         = local.aws_config_env.vpc.server.cidr
  transit_gateway_attachment_id  = aws_ec2_transit_gateway_peering_attachment.ap-southeast-2-to-us-east-1.id
  transit_gateway_route_table_id = aws_ec2_transit_gateway_route_table.ap-southeast-2-TGW-RT.id
}
...
resource "aws_ec2_transit_gateway_vpc_attachment" "us-east-1-vpc-proxy-3-attachment" {
  provider           = aws.us-west-1
  transit_gateway_id = aws_ec2_transit_gateway.us-west-1-TGW.id
...
resource "aws_ec2_transit_gateway_vpc_attachment" "us-east-1-vpc-proxy-2-attachment" {
  provider           = aws.ap-southeast-1
  transit_gateway_id = aws_ec2_transit_gateway.ap-southeast-1-TGW.id
...
resource "aws_ec2_transit_gateway_vpc_attachment" "us-east-1-vpc-proxy-1-attachment" {
  provider           = aws.ap-southeast-2
  transit_gateway_id = aws_ec2_transit_gateway.ap-southeast-2-TGW.id
